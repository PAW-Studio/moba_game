namespace Fusion
{
    ...
    public sealed unsafe class NetworkCharacterController : NetworkTRSP, INetworkTRSPTeleport, IBeforeAllTicks, IAfterAllTicks, IBeforeCopyPreviousState
    {
        ...
        public NetworkBool _isJumping;
        public void MoveNew(Vector3 direction, float moveSpeed, Animator characterAnimator)
        {
        ...
        public void Move(Vector3 direction, Animator characterAnimator)
        {
            var deltaTime = Runner.DeltaTime;
            var previousPos = transform.position;
            var moveVelocity = Data.Velocity;
